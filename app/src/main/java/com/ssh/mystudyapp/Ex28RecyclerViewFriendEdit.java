...
public class Ex28RecyclerViewFriendEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ex28_recyclerview_edit);

        helper = new MySQLiteOpenHelperFriends2(
                Ex28RecyclerViewFriendEdit.this, // 현재 화면의 context
                "friend.db", // 파일명
                null, // 커서 팩토리
                1); // 버전 번호
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (findName.equals("")) {
                    Toast.makeText(Ex28RecyclerViewFriendEdit.this, "이름을 입력해주세요.", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (findName.equals("")) {
                    ...
                    Toast.makeText(Ex28RecyclerViewFriendEdit.this, "연락처를 입력해주세요.", Toast.LENGTH_SHORT).show();
                    return;
                } else if (inputAddress.equals("")) {
                    Toast.makeText(Ex28RecyclerViewFriendEdit.this, "주소를 입력해주세요.", Toast.LENGTH_SHORT).show();
                    return;
                } else if (etAge.getText().toString().equals("")) {
                    Toast.makeText(Ex28RecyclerViewFriendEdit.this, "나이를 입력해주세요.", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                for (int i = 0; i < Ex28RecyclerViewFriendList.adapter.getItemCount(); i++) {
                    if (findName.equals(Ex28RecyclerViewFriendList.adapter.items.get(i).getName())) {
                        Toast.makeText(Ex28RecyclerViewFriendEdit.this, "수정되었습니다.", Toast.LENGTH_SHORT).show();
//                        Toast.makeText(Ex20FriendEditActivity.this, "수정체크:" + name + "/" + selectGender + "/" + age, Toast.LENGTH_SHORT).show();
                        //값자리 초기화
                        Ex28RecyclerViewFriendList.adapter.items.get(i).setName(name);
                        Ex28RecyclerViewFriendList.adapter.items.get(i).setHp(hp);
                        Ex28RecyclerViewFriendList.adapter.items.get(i).setAddr(addr);

                        Ex28RecyclerViewFriendList.adapter.items.get(i).setAge(age);
                        if ("남자".equals(Ex28RecyclerViewFriendList.adapter.items.get(i).getGender())) {
                            Ex28RecyclerViewFriendList.adapter.items.get(i).setGender(selectGender);
                        } else {
                            Ex28RecyclerViewFriendList.adapter.items.get(i).setGender(selectGender);
                        }
                    }
                ...
                etAddr.setText("");
                etAge.setText("");
                Toast.makeText(Ex28RecyclerViewFriendEdit.this, "수정이 완료되었습니다.", Toast.LENGTH_SHORT).show();
        ...
        btnCancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent main = new Intent(Ex28RecyclerViewFriendEdit.this, Ex28RecyclerViewFriendList.class);
                startActivity(main);
                finish();
            }
        });
