...
public class Ex25SQLiteFriendAdd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ex25_sqlite_friend_add);

        //데이베이스 생성.
        helper = new MySQLiteOpenHelperFriends(
                Ex25SQLiteFriendAdd.this, // 현재 화면의 context
                "friend.db", // 파일명
                null, // 커서 팩토리
                1); // 버전 번호
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (name.equals("")) {
                    Toast.makeText(Ex25SQLiteFriendAdd.this, "이름을 입력해주세요", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (hp.equals("")) {
                    Toast.makeText(Ex25SQLiteFriendAdd.this, "연락처를 입력해주세요", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (addr.equals("")) {
                    Toast.makeText(Ex25SQLiteFriendAdd.this, "주소를 입력해주세요", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (etAge.getText().toString().equals("")) {
                    Toast.makeText(Ex25SQLiteFriendAdd.this, "나이를 입력해주세요", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Toast.makeText(Ex25SQLiteFriendAdd.this, "친구가 추가되었습니다..", Toast.LENGTH_SHORT).show();
        ...
        btnCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent main = new Intent(Ex25SQLiteFriendAdd.this, Ex25SQLiteFriendListActivity.class);
                startActivity(main);
                finish();
            }
        });
    ...
    public void insert(String name, String hp, String gender, String addr, String age) {
        ...
        Ex25SQLiteFriendListActivity.selectFriendList();
    }
}