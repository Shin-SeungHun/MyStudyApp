...
public class Ex20ListViewFriendsAdapter extends BaseAdapter {
    ArrayList<Ex20FriendItems> items = new ArrayList<Ex20FriendItems>();
    ...
    public void addItem(Ex20FriendItems item) {
        items.add(item);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Ex20FriendItems friendsItem = items.get(position);

        if (convertView == null) {
            LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = inflater.inflate(R.layout.activity_ex20_friend_manager_items, parent, false);
        ...
        tvAddress.setText(friendsItem.getAddress());
