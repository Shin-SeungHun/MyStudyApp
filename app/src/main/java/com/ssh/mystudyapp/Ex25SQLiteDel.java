...
public class Ex25SQLiteDel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ex25_sqlite_del);

        helper = new MySQLiteOpenHelperFriends(
                Ex25SQLiteDel.this, // 현재 화면의 context
                "friend.db", // 파일명
                null, // 커서 팩토리
                1); // 버전 번호
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (findName.equals("")) {
                    Toast.makeText(Ex25SQLiteDel.this, "이름을 입력해주세요", Toast.LENGTH_SHORT).show();
                    return;
                }
...
//                    Log.d("아이템값체크", "아이템"+ Ex20FriendListActivity.adapter.items.get(i));
                    ...
                    if (findName.equals(Ex25SQLiteFriendListActivity.adapter.items.get(i).getName())) {
                        Toast.makeText(Ex25SQLiteDel.this, "친구를 찾았습니다.", Toast.LENGTH_SHORT).show();
                        etName.setText(Ex25SQLiteFriendListActivity.adapter.items.get(i).getName());
                        tvHp.setText(Ex25SQLiteFriendListActivity.adapter.items.get(i).getHp());
                        tvAddr.setText(Ex25SQLiteFriendListActivity.adapter.items.get(i).getAddress());
                        tvAge.setText(Ex25SQLiteFriendListActivity.adapter.items.get(i).getAge() + "");
                        tvGender.setText(Ex25SQLiteFriendListActivity.adapter.items.get(i).getGender());
                    }
        ...
        btnDel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < Ex25SQLiteFriendListActivity.adapter.getCount(); i++) {
                    ...
                    if (findName.equals(Ex25SQLiteFriendListActivity.adapter.items.get(i).getName())) {
                        Ex25SQLiteFriendListActivity.adapter.items.remove(i);
                        Toast.makeText(Ex25SQLiteDel.this, "친구를 삭제했습니다.", Toast.LENGTH_SHORT).show();
                        break;
                    }
                }
                ...
                Toast.makeText(Ex25SQLiteDel.this, "삭제되었습니다.", Toast.LENGTH_SHORT).show();
                delete(findName);
            }
        });
        ...
        btnCancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent main = new Intent(Ex25SQLiteDel.this, Ex25SQLiteFriendListActivity.class);
                startActivity(main);
                finish();
            }
        });
